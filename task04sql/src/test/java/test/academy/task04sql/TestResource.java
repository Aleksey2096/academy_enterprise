package test.academy.task04sql;
...
import by.academy.task04sql.service.PersonCollectionCreator;
...
public class TestResource {
    public static final CollectionDao<Person> PERSON_COLLECTION_DAO
            = new PersonCollectionDao();
    public static final PersonCollectionCreator PERSON_COLLECTION_CREATOR
            = new PersonCollectionCreator();
    public static final PersonCollectionUtilService
            PERSON_COLLECTION_UTIL_SERVICE = new PersonCollectionUtilService();
    public static final CollectionPrinter COLLECTION_PRINTER
            = new CollectionPrinter();

    public static final String TEST_PEOPLE_RESOURCE_FILE
            = Objects.requireNonNull(
            TestResource.class.getClassLoader()
                    .getResource("data/testPeople.dat")).getFile();
    ...
    public static final String TEST_AGE_VALUE_FOR_PERSON_MESSAGE
            = "Test age value for person = ";
