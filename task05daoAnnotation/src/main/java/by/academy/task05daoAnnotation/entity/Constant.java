...
public final class Constant {
	...
	public static final String DELETE_MESSAGE_1 = "Deleted person (changed rows) = ";
	...
	public static final String CLASS_ANNOTATION_EXCEPTION_MESSAGE = "Object class has no annotation \"MyTable\"!";
	public static final String FIELD_ANNOTATION_EXCEPTION_MESSAGE = "Object has no field annotated as \"MyColumn\"!";
	...
	public static final String PERSON_TO_STRING_MESSAGE = "Person [id=%d, name=%s, surname=%s]";
