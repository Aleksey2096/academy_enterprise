...
public class AuthController {
    ...
    public AuthController(final AuthenticationManager newAuthenticationManager,
                          final UserRepository newUserRepository,
                          final RoleRepository newRoleRepository,
                          final PasswordEncoder newEncoder, final JwtUtils newJwtUtils) {
