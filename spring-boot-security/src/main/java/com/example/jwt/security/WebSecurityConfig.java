...
public class WebSecurityConfig { // extends WebSecurityConfigurerAdapter {
    ...
    public WebSecurityConfig(final UserDetailsServiceImpl newUserDetailsService,
                             final AuthEntryPointJwt newUnauthorizedHandler) {
        userDetailsService = newUserDetailsService;
        unauthorizedHandler = newUnauthorizedHandler;
    }
