...
class CashCardApplicationTests {
    ...
    public void shouldCreateANewCashCard() {
        ...
        assertThat(Objects.requireNonNull(responseEntityOfGet.getBody()).amount()).isEqualTo(newCashCard.amount());
    }
    ...
    public void shouldUpdateExistingCashCardWhenItExistsAndUserOwnsIt() {
        ...
        ResponseEntity<CashCard> responseEntityOfGet =
                restTemplate
                        .withBasicAuth("sarah1", "abc123")
                        .getForEntity("/cashcards/99", CashCard.class);
        assertThat(Objects.requireNonNull(responseEntityOfGet.getBody()).amount()).isEqualTo(cashCardUpdate.amount());
    }
