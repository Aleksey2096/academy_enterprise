...
<head>
    <meta charset="UTF-8">
    <title><fmt:message key="page.administratorOrdersPage" bundle="${rb}"/></title>
...
<div class="main">
    ...
    <div class="mainTable">
        <div class="container">
            <ul class="responsive-table orders">
                ...
                <li class="table-header">
                    ...
                    <span class="sortSpan">
                        <a class="sortAnchor"
                           href="${pageContext.request.contextPath}/dispatcher?command=${requestScope.command}&orderField=userEntity&orderType=asc&searchValue=${requestScope.searchValue}&recordsPerPage=${requestScope.orders.recordsPerPage}&currentPage=${requestScope.orders.currentPage}">∧</a>
                    </span>
                        <fmt:message key="table.healthCareCardNumber" bundle="${rb}"/>
                        <span class="sortSpan">
                        <a class="sortAnchor"
                           href="${pageContext.request.contextPath}/dispatcher?command=${requestScope.command}&orderField=userEntity&orderType=desc&searchValue=${requestScope.searchValue}&recordsPerPage=${requestScope.orders.recordsPerPage}&currentPage=${requestScope.orders.currentPage}">∨</a>
                    </span>
                    </div>
                    <div class="col col-5">
                    <span class="sortSpan">
                ...
                <c:forEach var="elem" items="${requestScope.orders.records}" varStatus="status">
                    <li class="table-row">
                        ...
                        <div class="col col-4">${elem.userDTO.healthCareCardNumber}</div>
                        <div class="col col-5">${elem.medicineProductDTO.id}</div>
                        <div class="col col-6">${elem.amount}</div>
                        <div class="col col-7">${elem.price}</div>
                        <div class="col col-8">${elem.paymentCardNumber}</div>
                        <div class="col col-9">${elem.contactPhone}</div>
                        <div class="col col-10">${elem.deliveryAddress}</div>
                    </li>
                </c:forEach>
            </ul>
        </div>
